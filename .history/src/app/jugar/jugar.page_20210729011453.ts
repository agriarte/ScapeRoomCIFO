...
export class JugarPage implements OnInit, OnDestroy {
  ...
  comenzarJuego() {
    ...
    // comenzar juego si no ha empezado
    if (localStorage.getItem('juego') !== 'iniciado') {
      localStorage.setItem('juego', 'iniciado');
      this.iniciarTemporizador();
    } else {
      alert('El juego ya ha comenzado. ¡Espabila que el tiempo pasa volando!');
    }
  }
